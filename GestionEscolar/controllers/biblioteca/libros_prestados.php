...
<nav class="navbar">
      ...
      <div class="links">
      <a href="../../controllers/biblioteca_estudiante.php">Inicio</a>
        <div class="dropdown">
          <a href="#"
            >Explore
          ...
          <div class="menu">
            <a href="../../controllers/biblioteca/libros_prestados.php"> Prestamos</a>
           
            
          </div>
        </div>
        <a href="../biblioteca/classroom.php" class="join-link"> Cerrar Sesión </a>
      </div>
    </nav>
<br><br><br><br><br>
